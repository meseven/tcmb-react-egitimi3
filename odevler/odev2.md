...
- [ ] Yine yukarıdaki görselde görüleceği üzere, içinde bulunduğumuz gün bir background veya border ile belirginleştirilmelidir.
- [ ] Günlerin listelendiği kartlarda gün adı, hava durumu görseli(güneşli, yağmurlu, karlı, parçalı bulutlu) ve en yüksek/en düşük sıcaklık gösterilmelidir.
